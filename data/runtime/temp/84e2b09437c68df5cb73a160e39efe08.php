<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:38:"themes/97013266/user/tube/details.html";i:1570008884;s:32:"themes/97013266/public/head.html";i:1570008884;s:36:"themes/97013266/public/function.html";i:1570008884;s:35:"themes/97013266/public/nav_new.html";i:1570008884;s:32:"themes/97013266/public/tube.html";i:1570008884;s:35:"themes/97013266/public/scripts.html";i:1570008884;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="__TMPL__/public/assets/js/plist_parser.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5dd3482c9627d,null,false);
 ?>
</head>
            ...
            <div class="col-sm-12 details-type">
                <div class="col-sm-6 details-type-tou">
                    ...
                    <div class="col-sm-6 details-type-p pad-left_right">
                        ...
                        <div class="col-sm-12 "><span class="details-type-p2-1">
                            <?php if($assets['test_type'] == 1): ?>
                            内测版
                            <?php else: ?>
                            企业版
                            <?php endif; ?>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="tube-tiz details-tiz">
                        <a class="bogo-global-btn" href="<?php echo $assets['url']; ?>" data-url="<?php echo $assets['url']; ?>"
                ...
                <?php if(is_array($type) || $type instanceof \think\Collection || $type instanceof \think\Paginator): if( count($type)==0 ) : echo "" ;else: foreach($type as $key=>$vo): ?>
                    <tr>
                        ...
                        <td class="tube-tiz details-tiz">
                            <a class="bogo-global-btn" href="<?php echo $vo['url']; ?>" data-url="<?php echo $vo['url']; ?>" data-id="<?php echo $vo['id']; ?>"
                               class="downfile">下载</a>

                            <a class="bogo-global-btn tube-tiz12"
                               href="<?php echo cmf_url('user/tube/del',array('id'=>$vo['id'])); ?>">删除</a>
                        </td>
                    </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
...
<script>
    ...
    <?php 
    \think\Hook::listen('before_body_end',$temp5dd3482c962de,null,false);
 ?>
</body>
</html>
