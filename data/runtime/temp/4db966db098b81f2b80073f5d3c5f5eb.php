<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:42:"themes/97013266/user/profile/password.html";i:1570008884;s:32:"themes/97013266/public/head.html";i:1570008884;s:36:"themes/97013266/public/function.html";i:1570008884;s:35:"themes/97013266/public/nav_new.html";i:1570008884;s:35:"themes/97013266/public/scripts.html";i:1570008884;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="__TMPL__/public/assets/js/plist_parser.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5e78aa209010f,null,false);
 ?>
</head>
<body class="body-all">
...
<div class="user-left">
	<div class="user-left-top">
		<p>个人中心> <span class="span-c">修改密码</span></p>
	</div>
    <div class="user-left-bottom">
        <div class="tab-content">
        	<div class="tab-content-top">修改密码</div>
            <div class="password-box">
               <div class="tab-pane active" id="one">
                    <br>
                    <form class="js-ajax-form" action="<?php echo url('user/Profile/passwordPost'); ?>" method="post">
                        <div class="pass-user-box">
                            <label for="input-old_password" class="pass-user-l">原始密码</label>
                            <input type="password" class="form-control" id="input-old_password" placeholder="原始密码" name="old_password">
                        </div>
                        <div class="pass-user-box">
                            <label for="input-password" class="pass-user-l">新密码</label>
                            <input type="password" class="form-control" id="input-password" placeholder="新密码" name="password">
                        </div>
                        <div class="pass-user-box">
                            <label for="input-repassword" class="pass-user-l">重复密码</label>
